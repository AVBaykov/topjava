...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    void testGetBetween() throws Exception {
        ...
        testBetween(params, MEALS_TO.subList(3, 6));
    ...
    void testGetBetweenWithNulls() throws Exception {
        ...
        params.add("endTime", "23:00");
        testBetween(params, MEALS_TO);
    }

    private ResultActions testBetween(MultiValueMap<String, String> params, List<MealTo> expected) throws Exception {
        return TestUtil.print(mockMvc.perform(get(REST_URL + "filter").params(params))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
